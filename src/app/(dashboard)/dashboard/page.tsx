            ...
            <aside className="flex w-80 shrink-0 flex-col gap-6 overflow-y-auto border-r border-border bg-[#fdf6ee] p-5">
				...
				{pipeline.phase === "done" && (
					<button
						...
						className="flex items-center justify-center gap-2 rounded-lg border border-[#4a6fa5]/30 bg-[#08051a] px-4 py-2.5 text-center text-sm font-medium text-[#7eb4e2] transition-colors hover:border-[#4a6fa5]/60 hover:text-[#a0c4ff] disabled:pointer-events-none disabled:opacity-60"
					>
						{notes.generating && (
